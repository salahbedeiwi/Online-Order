<?php
	...
	$host_user = "root";
	$host_pass = "";
	$host_db   = "online_order"; //db name
	// $host_name = "www.salahbedeiwi.com";
	// $host_user = "Demo123";
	// $host_pass = ",ssqQ";
	// $host_db   = "Demo"; //db name
	
	
	$connect = @mysql_connect($host_name,$host_user,$host_pass) 
					or exit("Error1: Sorry you need to settup the user connection to the database. contact salahbedeiwi.com for this subscription");
